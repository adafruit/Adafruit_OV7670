...
ov2640_vga[] = {
	{OV2640_REG_RA_DLMT, OV2640_RA_DLMT_DSP},     // Bank select DSP (REG0)
	{0x2C, 0xFF},  // Reserved
	{0x2E, 0xDF},  // Reserved
	{OV2640_REG_RA_DLMT, OV2640_RA_DLMT_SENSOR},  // Bank select sensor (1)
	{0x3C, 0x32},  // Reserved
	...
	{0xE5, 0x7F}, // Reserved
	{OV2640_REG0_MC_BIST,
         OV2640_MC_BIST_RESET_MASK | OV2640_MC_BIST_BOOTROM_MASK},
	{0x41, 0x24}, // Reserved
	{OV2640_REG0_RESET, OV2640_RESET_JPEG_MASK | OV2640_RESET_DVP_MASK},
	{0x76, 0xFF}, // Reserved
	{0x33, 0xA0}, // Reserved
	{0x42, 0x20}, // Reserved
	{0x43, 0x18}, // Reserved
	{0x4C, 0x00}, // Reserved
	{OV2640_REG0_CTRL3, // Module enable
         OV2640_CTRL3_BPC_MASK | OV2640_CTRL3_WPC_MASK | 0x10},
	{0x88, 0x3F}, // Reserved
	{0xD7, 0x03}, // Reserved
	{0xD9, 0x10}, // Reserved
	{OV2640_REG0_R_DVP_SP, OV2640_R_DVP_SP_AUTO_MASK | 0x02},
	{0xC8, 0x08}, // Reserved
	{0xC9, 0x80}, // Reserved
	...
	{0x90, 0x00}, // Reserved (guessing this is an addr/data setup)
	{0x91, 0x0E}, // Reserved
	{0x91, 0x1A}, // Reserved
	{0x91, 0x31}, // Reserved
	{0x91, 0x5A}, // Reserved
	...
	{0x91, 0xe8}, // Reserved
	{0x91, 0x20}, // Reserved
	{0x92, 0x00}, // Reserved (addr/data again?)
	{0x93, 0x06}, // Reserved
	{0x93, 0xe3}, // Reserved
	{0x93, 0x02}, // Reserved
	{0x93, 0x02}, // Reserved
	...
	{0x96, 0x00}, // Reserved (another addr/data?)
	{0x97, 0x08}, // Reserved
	{0x97, 0x19}, // Reserved
	{0x97, 0x02}, // Reserved
	{0x97, 0x0c}, // Reserved
	...
	{0x97, 0x00}, // Reserved
	{0x97, 0x00}, // Reserved
	{OV2640_REG0_CTRL1, ~OV2640_CTRL1_DG_MASK}, // Enable all but DG
	{OV2640_REG_RA_DLMT, OV2640_RA_DLMT_DSP}, // Bank select DSP (REG0)
	{0xBA, 0xDC}, // Reserved
	{0xBB, 0x08}, // Reserved
	{0xB6, 0x24}, // Reserved
	...
	{OV2640_REG0_CTRL2, OV2640_CTRL2_DCW_MASK | OV2640_CTRL2_SDE_MASK |
         OV2640_CTRL2_UV_ADJ_MASK | OV2640_CTRL2_UV_AVG_MASK |
         OV2640_CTRL2_CMX_MASK},
	{OV2640_REG0_CTRLI, OV2640_CTRLI_LP_DP_MASK | 0x82}, // H/V dividers
	...
	{OV2640_REG0_R_DVP_SP, 0x04}, // Manual DVP PCLK setting
	{0x7F, 0x00}, // Reserved
	{OV2640_REG0_IMAGE_MODE, 0x00}, // Uncompressed YUV MSB first
	{0xE5, 0x1F}, // Reserved
	{0xE1, 0x67}, // Reserved
	{OV2640_REG0_RESET, 0x00}, // Reset nothing?
	{0xDD, 0x7F}, // Reserved
	{OV2640_REG0_R_BYPASS, 0x00}, // DSP enable
	{OV2640_REG_RA_DLMT, OV2640_RA_DLMT_DSP}, // Bank select DSP (REG0)
	{OV2640_REG0_RESET, OV2640_RESET_DVP_MASK},
	{OV2640_REG0_HSIZE8, 0xC8}, // Image horiz size MSBs
	{OV2640_REG0_VSIZE8, 0x96}, // Image vert size MSBs
	{OV2640_REG0_CTRL2, OV2640_CTRL2_DCW_MASK | OV2640_CTRL2_SDE_MASK |
         OV2640_CTRL2_UV_ADJ_MASK | OV2640_CTRL2_UV_AVG_MASK |
         OV2640_CTRL2_CMX_MASK}, // Module enable
	{OV2640_REG0_CTRLI, OV2640_CTRLI_LP_DP_MASK | 0x12},
	{OV2640_REG0_HSIZE, 0x90}, // H_SIZE low bits
	{OV2640_REG0_VSIZE, 0x2C}, // V_SIZE low bits
	{OV2640_REG0_XOFFL, 0x00}, // OFFSET_X low bits
	{OV2640_REG0_YOFFL, 0x00}, // OFFSET_y low bits
	...
	{OV2640_REG_RA_DLMT, OV2640_RA_DLMT_DSP}, // Bank select DSP (REG0)
	{OV2640_REG0_R_BYPASS, OV2640_R_BYPASS_DSP_ENABLE}, // DSP enable
	{OV2640_REG0_IMAGE_MODE, OV2640_IMAGE_MODE_DVP_RGB565},
	{OV2640_REG0_IMAGE_MODE,
         OV2640_IMAGE_MODE_DVP_RGB565 | OV2640_IMAGE_MODE_SWAP_MASK},
	{0x98, 0x00}, // Reserved
	{0x99, 0x00}, // Reserved
	{0x00, 0x00}, // Reserved
	{OV2640_REG_RA_DLMT, OV2640_RA_DLMT_DSP}, // Bank select DSP (REG0)
	...
	{OV2640_REG0_CTRL2, OV2640_CTRL2_DCW_MASK | OV2640_CTRL2_SDE_MASK |
         OV2640_CTRL2_UV_ADJ_MASK | OV2640_CTRL2_UV_AVG_MASK |
         OV2640_CTRL2_CMX_MASK},
	{OV2640_REG0_CTRLI, OV2640_CTRLI_LP_DP_MASK | 0x09},
	{OV2640_REG0_HSIZE, 0x90}, // H_SIZE low bits
	{OV2640_REG0_VSIZE, 0x2C}, // V_SIZE low bits
	{OV2640_REG0_XOFFL, 0x00}, // OFFSET_X low bits
	{OV2640_REG0_YOFFL, 0x00}, // OFFSET_Y low bits
...
ov2640_qqvga[] = {
        ...
        {OV2640_REG0_CTRL2, OV2640_CTRL2_DCW_MASK | OV2640_CTRL2_SDE_MASK |
         OV2640_CTRL2_UV_AVG_MASK | OV2640_CTRL2_CMX_MASK},
